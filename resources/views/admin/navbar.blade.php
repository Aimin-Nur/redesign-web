        ...
        <h1 class="navbar-brand navbar-brand-autodark">
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/dashboardAdmin/{id}" >
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="/verifUser/{id}">
                        Verifikasi User
                      </a>
                      <a class="dropdown-item" href="/manageUser/{id}">
                        Manage User
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="/managePortofolio/{id}">
                        Manage Portofolio
                      </a>
                      <a class="dropdown-item" href="/addPorto/{id}">
                        Tambah Portofolio
                      </a>
                    </div>
                  </div>
        ...
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url({{asset('demo')}}/./static/avatars/admin.png)"></span>
                <div class="d-none d-xl-block ps-2">
                  <div>Aimin Nur</div>
