                        ...
                        <div class="card">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="btn-group ms-auto">
                                    <a href="/portofolioMalewa" target="_blank" class="btn btn-md btn-primary btn-icon">
                                    ...
                                    <a href="/editPortoByUser/{{$artikel->id}}" class="btn btn-md btn-warning btn-icon">
        ...
        <div class="modal modal-blur fade" id="modal-danger{{$artikel->id}}" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="w-100">
                    ...
                    <div class="col"><a href="/destroyPortoByUser/{{$artikel->id}}" class="btn btn-danger w-100">
                        Hapus Artikel
                        </a></div>
                    </div>
                </div>
